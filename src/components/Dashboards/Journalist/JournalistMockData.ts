...
export const INITIAL_ARTICLES: ArticlePost[] = [
  ...
  {
    id: 'art-2',
    headline: 'MATCH REVIEW: Engineering XI and Agriculture FC Battle Out Goalless First Half',
  ...
  {
    id: 'art-3',
    headline: 'TRANSFER NEWS: Maragoli Strikers Target Campus Top Scorer Ahead of Window',

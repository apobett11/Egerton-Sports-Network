...
export const initialStandings: StandingEntry[] = [
    { position: 1, teamName: 'Man City', teamLogo: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=100&auto=format&fit=crop&q=80', played: 23, won: 16, drawn: 6, lost: 1, goalsFor: 52, goalsAgainst: 18, goalDifference: 34, points: 54, isCurrent: false },
    { position: 2, teamName: 'Liverpool', teamLogo: 'https://images.unsplash.com/photo-1522778119026-d647f0596c20?w=100&auto=format&fit=crop&q=80', played: 23, won: 15, drawn: 7, lost: 1, goalsFor: 50, goalsAgainst: 20, goalDifference: 30, points: 52, isCurrent: false },
    { position: 3, teamName: 'Arsenal', teamLogo: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=100&auto=format&fit=crop&q=80', played: 23, won: 15, drawn: 5, lost: 3, goalsFor: 44, goalsAgainst: 19, goalDifference: 25, points: 50, isCurrent: false },
    { position: 4, teamName: 'Egerton FC', teamLogo: 'https://images.unsplash.com/photo-1517649763962-0c623266010b?w=100&auto=format&fit=crop&q=80', played: 23, won: 14, drawn: 6, lost: 3, goalsFor: 42, goalsAgainst: 22, goalDifference: 20, points: 48, isCurrent: true },
    { position: 5, teamName: 'Tottenham', teamLogo: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=100&auto=format&fit=crop&q=80', played: 23, won: 13, drawn: 5, lost: 5, goalsFor: 41, goalsAgainst: 24, goalDifference: 17, points: 44, isCurrent: false },
    { position: 6, teamName: 'Chelsea', teamLogo: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=100&auto=format&fit=crop&q=80', played: 23, won: 11, drawn: 6, lost: 6, goalsFor: 38, goalsAgainst: 28, goalDifference: 10, points: 39, isCurrent: false },
    { position: 7, teamName: 'Newcastle', teamLogo: 'https://images.unsplash.com/photo-1522778119026-d647f0596c20?w=100&auto=format&fit=crop&q=80', played: 23, won: 10, drawn: 5, lost: 8, goalsFor: 35, goalsAgainst: 31, goalDifference: 4, points: 35, isCurrent: false }
];

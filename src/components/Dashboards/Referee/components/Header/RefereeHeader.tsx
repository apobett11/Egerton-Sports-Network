...
export const RefereeHeader: React.FC<RefereeHeaderProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* TASK 7 — HOMEPAGE HEADER REDESIGN: Greeting ONLY */}
      <div className="pt-2">
        <span className="text-xs font-semibold uppercase tracking-wider text-slate-400 block">Hello,</span>
        <h1 className="text-2xl font-black text-white tracking-tight">{currentUserName}</h1>
      </div>

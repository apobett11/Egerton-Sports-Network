    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
          {/* WORKFLOW STEP GUIDE (Make Next Step So Obvious) */}
          <div className="bg-slate-100 dark:bg-[#07111c] border border-slate-200 dark:border-[#1a2e45] rounded-lg p-3 sm:p-3.5">
            <div className="flex items-center justify-between gap-2 overflow-x-auto text-[11px] font-bold">
              ...
              <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 shrink-0">
                <div className="w-6 h-6 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center font-mono font-black text-xs text-emerald-500 dark:text-emerald-400">
                  ✓
                </div>
                <div>
                  <span className="block uppercase text-[9px] text-slate-400 font-black">Step 1 • Verified</span>
                  <span className="font-bold text-slate-800 dark:text-slate-200">Lineup & Venue</span>
                </div>
              </div>
              <div className="h-0.5 w-6 bg-slate-300 dark:bg-slate-700 shrink-0 hidden sm:block" />
              {/* Step 2 */}
              <div className="flex items-center gap-2 text-amber-500 dark:text-amber-400 shrink-0">
                <div className="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-500/40 flex items-center justify-center font-mono font-black text-xs text-amber-500 dark:text-amber-400">
                  2
                </div>
                <div>
                  <span className="block uppercase text-[9px] text-slate-400 font-black">Step 2 • In Progress</span>
                  <span className="font-bold text-slate-800 dark:text-slate-200">Log Events ({events.length})</span>
                </div>
              </div>
              <div className="h-0.5 w-6 bg-slate-300 dark:bg-slate-700 shrink-0 hidden sm:block" />
              {/* Step 3 */}
              <div className="flex items-center gap-2 text-[#00b04f] shrink-0">
                ...
                <div>
                  <span className="block uppercase text-[9px] text-[#00b04f] font-black">Step 3 • Next Step</span>
                  <span className="font-bold text-slate-900 dark:text-white">Submit Report (FT)</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* BOTTOM ACTION BAR: MAKE NEXT STEP SO OBVIOUS */}
        <div className="p-4 sm:p-5 border-t border-slate-200 dark:border-[#182e47] bg-slate-50 dark:bg-[#09131d] flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="text-center sm:text-left">
            <span className="text-[10px] font-black uppercase tracking-widest text-[#00b04f] flex items-center justify-center sm:justify-start gap-1.5">
              <ShieldCheck className="w-3.5 h-3.5" />
              Final Stage • Match Certification
            </span>
            <p className="text-xs text-slate-500 dark:text-slate-400">
              {events.length === 0 
                ? "Submitting will certify this fixture as an official 0 — 0 Full Time draw."
                : `Ready to submit ${events.length} logged event${events.length === 1 ? '' : 's'} and finalize Full Time score (${calculatedScore.home} - ${calculatedScore.away}).`}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2.5 w-full sm:w-auto">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2.5 rounded-lg border border-slate-300 dark:border-white/10 hover:bg-slate-200 dark:hover:bg-[#152a40] text-slate-600 dark:text-slate-300 text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer"
            >
              Exit
            </button>
            ...
            <button
              ...
              className="flex-1 sm:flex-none px-6 py-2.5 rounded-lg bg-gradient-to-r from-[#00b04f] to-emerald-600 hover:from-[#009b45] hover:to-emerald-500 text-white font-black text-xs sm:text-sm uppercase tracking-wider shadow-lg shadow-emerald-900/30 hover:shadow-emerald-900/50 transition-all cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50 active:scale-95"
            >
              <span>NEXT STEP: Submit Match Report (FT)</span>
            ...
            >
              ...
              <div className="pt-3 border-t border-slate-200 dark:border-[#182e47] flex items-center justify-end gap-2.5">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-lg bg-[#00b04f] hover:bg-[#009b45] text-white font-black text-xs uppercase tracking-wider transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-2 shadow-xs"
                >
                  <span>NEXT STEP: Add Event to Match Timeline</span>
                  <ArrowRight className="w-4 h-4" />
                </button>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-slate-100 dark:border-[#14263b]">
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="px-6 py-2.5 rounded-lg bg-gradient-to-r from-[#00b04f] to-emerald-600 hover:from-[#009b45] hover:to-emerald-500 text-white text-xs font-black uppercase tracking-wider transition-all cursor-pointer disabled:opacity-50 flex items-center gap-2 shadow-md shadow-emerald-900/30"
                >
                  <span>{isSubmitting ? 'Submitting...' : 'NEXT STEP: Finalize & Certify (FT)'}</span>
                  <ArrowRight className="w-4 h-4" />
                </button>
              </div>
            </div>

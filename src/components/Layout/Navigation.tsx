...
export const Navigation: React.FC<NavigationProps> = ({
    ...
    // Keep the row blank on the Standings page
    if (activeTab === 'table') {
        return (
            <div className="w-full bg-white dark:bg-[#0e1c2b] border-b border-[#e6e8ec] dark:border-[#1a2e45] py-1 px-4 select-none" />
        );
    }
            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="px-3 py-1 text-xs font-bold rounded-md cursor-pointer transition-colors text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-[#14263b]"
                    >

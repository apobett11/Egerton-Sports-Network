  ...
  for (const playerEvents of byPlayer.values()) {
    ...
    if (yellows.length >= 2) {
      ...
      const redCardEvent: MatchEvent = {
        ...
        last_modified_by_role: secondYellow.last_modified_by_role || secondYellow.created_by_role,
        last_modified_by_uid: secondYellow.last_modified_by_uid || secondYellow.created_by_uid,

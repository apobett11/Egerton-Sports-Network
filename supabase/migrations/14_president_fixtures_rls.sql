...
INSERT INTO public.teams (id, club_id, competition_id, name, short_name, color_code, status)
VALUES 
  ('c1111111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222222', 'Championship FC Alpha', 'CHP-A', '#10B981', 'approved'),
  ('c2222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', '22222222-2222-2222-2222-222222222222', 'Championship FC Beta', 'CHP-B', '#6366F1', 'approved'),
  ('c3333333-3333-3333-3333-333333333333', '55555555-5555-5555-5555-555555555555', '22222222-2222-2222-2222-222222222222', 'Championship FC Gamma', 'CHP-C', '#F59E0B', 'approved'),
  ('c4444444-4444-4444-4444-444444444444', '33333333-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222222', 'Championship FC Delta', 'CHP-D', '#EC4899', 'approved')
ON CONFLICT (id) DO NOTHING;
